  ...
  return (
    ...
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-24 '>
        <p className='text-xl tracking-widest uppercase text-[#FF018E]'>
          Contact
        </p>
        <h2 className='py-4'>Get In Touch</h2>
        <div className='grid lg:grid-cols-5 gap-8'>
          {/* left */}
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4 bg-slate-100'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2 text-black'>Jun Kevin</h2>
              ...
              <div>
                <p className='uppercase pt-8 text-black'>Connect With Me</p>
          ...
          {/* right */}
          <div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4 bg-slate-100'>
            <div className='p-4'>
              <form
