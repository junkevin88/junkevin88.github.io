...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={
          nav ? 'md:hidden fixed left-0 top-0 p-10 w-full h-screen bg-black/70' : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'
        }
      >
        {/* Side Drawer Menu */}
        <div
          className={
            nav
              ...
              : 'fixed left-[-100%] w-[75%] sm:w-[60%] md:w-[45%] top-0 p-10 h-screen ease-in duration-500'
          }
        >
          <div>
