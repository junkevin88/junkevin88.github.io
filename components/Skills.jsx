...
import Spring from '../public/assets/skills/spring-icon.svg'
import Java from '../public/assets/skills/java.svg';
import Laravel from '../public/assets/skills/laravel.svg';
import NodeJS from '../public/assets/skills/nodejs-icon.svg';
import AWS from '../public/assets/skills/aws.png';

const Skills = () => {
  return (
    <div id='skills' className='w-full lg:h-screen p-2'>
      <div className='max-w-[1240px] mx-auto px-2 py-24  flex flex-col justify-center h-full'>
        <p className='text-xl tracking-widest uppercase text-[#ff69b4]'>
          Skills
        </p>
        <h2 className='py-4'>What I Can Do</h2>
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='p-6 shadow-xl rounded-xl bg-slate-100 hover:scale-105 ease-in duration-300'>
